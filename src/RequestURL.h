...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &RequestURL::textBox1_TextChanged);
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(218, 229);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(213, 32);
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button3->Location = System::Drawing::Point(12, 229);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(200, 32);
			this->button3->TabIndex = 7;
			this->button3->Text = L"Get image URLs";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &RequestURL::button3_Click);
			// 
			// RequestURL
			// 
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		for (size_t i = 0; i < this->checkedListBox1->Items->Count; i++)
		{
			if(this->checkedListBox1->GetItemCheckState(i) == CheckState::Checked)
				URLS.push_back(context.marshal_as<std::string>(this->checkedListBox1->Items[i]->ToString()));
		}
		...
		if(!AllFilesDownloaded)
			MessageBox::Show("NOTE: Could not download one or more files!");
		else
